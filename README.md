...
Grant application submitted to: [NLnet Foundation](https://nlnet.nl) NGI Zero Commons Fund (2026-06-3ac) | €40,000 | Status: Pending review
...
Grant Information
 ...
 • Status: Pending review (application submitted June 2026)
 • Funder: NLnet Foundation (https://nlnet.nl/) (application submitted)
 • Grant ID: 2026-06-3ac
 • Amount: €40,000 (requested)
 • Duration: 12 months (Sept 2026 - Aug 2027, pending approval)
...
This project has submitted a grant application to the NLnet Foundation (https://nlnet.nl/) NGI Zero Commons Fund (2026-06-3ac) | €40,000 | Status: Pending review
╔═════════════════════════════════════╗
║   Grant application submitted to    ║
║   NLnet Foundation NGI Zero Fund    ║
...
Grant application pending — NLnet NGI Zero Commons Fund.
